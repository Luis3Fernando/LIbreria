...
import static itp_library.Interfaz.content;
/**
 *
 * @author Antonio
 */
public class NuevoLibro extends javax.swing.JPanel {
    ...
    public NuevoLibro(String bid, String titulo, String fecha, String autor, String categoria, String edic, String idioma, String paginas, String descripcion, String bejem, String bstock, String cantidad){
        initComponents();
        conn = new Conexion();
        reg = conn.getConnection();
        edicion = true;
        ...
        edit.setText(edic);
        lang.setText(idioma);
        pages.setText(paginas);
        descr.setText(descripcion);
        ejem.setText(bejem);
        stock.setText(bstock);
        available.setText(cantidad);
    ...
    private void initComponents() {
        ...
        button.setBackground(new java.awt.Color(191, 151, 128));
        ...
        Text3.setForeground(new java.awt.Color(85, 61, 42));
        ...
        jSeparator4.setForeground(new java.awt.Color(191, 151, 128));
        jSeparator4.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 260, 10));

        Text6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Text6.setForeground(new java.awt.Color(85, 61, 42));
        ...
        jSeparator7.setForeground(new java.awt.Color(191, 151, 128));
        jSeparator7.setPreferredSize(new java.awt.Dimension(200, 10));
        add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 260, 10));

        Text7.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Text7.setForeground(new java.awt.Color(85, 61, 42));
        ...
        jSeparator8.setForeground(new java.awt.Color(191, 151, 128));
        ...
        Text8.setForeground(new java.awt.Color(85, 61, 42));
        Text8.setText("Autor");
        ...
        jSeparator9.setForeground(new java.awt.Color(191, 151, 128));
        ...
        Text9.setForeground(new java.awt.Color(85, 61, 42));
        ...
        jSeparator10.setForeground(new java.awt.Color(191, 151, 128));
        ...
        jSeparator11.setForeground(new java.awt.Color(191, 151, 128));
        ...
        jSeparator5.setForeground(new java.awt.Color(191, 151, 128));
        ...
        Text11.setForeground(new java.awt.Color(85, 61, 42));
        ...
        jSeparator12.setForeground(new java.awt.Color(191, 151, 128));
        ...
        Text12.setForeground(new java.awt.Color(85, 61, 42));
        ...
        jSeparator13.setForeground(new java.awt.Color(191, 151, 128));
        ...
        Text13.setForeground(new java.awt.Color(85, 61, 42));
        ...
        jSeparator14.setForeground(new java.awt.Color(191, 151, 128));
        ...
        Text14.setForeground(new java.awt.Color(85, 61, 42));
        ...
        jSeparator15.setForeground(new java.awt.Color(191, 151, 128));
        ...
        jSeparator16.setForeground(new java.awt.Color(191, 151, 128));
        ...
        Text15.setForeground(new java.awt.Color(85, 61, 42));
    ...
    private void buttonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonMousePressed
        ...
        else
        {
            ...
            String btitulo = title.getText();
            String bfecha = date.getText();
            String bautor = author.getText();
            String bcategoria = category.getText();
            String bedicion = edit.getText();
            String bidioma = lang.getText();
            String bpaginas = pages.getText();
            String bdescrip = descr.getText();
            String bstock = stock.getText();
            String bcanti = available.getText();
            String bejem = ejem.getText();
            int pag=0;
            int stc=0;
            int av=0;

            if(bid == null || "".equals(bid) || btitulo == null || "".equals(btitulo) || bfecha == null || "".equals(bfecha) 
                    || bautor == null || "".equals(bautor) || bcategoria == null || "".equals(bcategoria) 
                    || bedicion == null || "".equals(bedicion) || bidioma == null || "".equals(bidioma) || bpaginas == null || "".equals(bpaginas) 
                    || bdescrip == null || "".equals(bdescrip) || bstock == null || "".equals(bstock) 
                    || bcanti == null || "".equals(bcanti) || bejem == null || "".equals(bejem)){
                javax.swing.JOptionPane.showMessageDialog(this, "Debe llenar todos los campos \n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                id.requestFocus();
            }
            else{ 
                try{
                    pag = Integer.parseInt(bpaginas);
                    stc = Integer.parseInt(bstock);
                    av = Integer.parseInt(bcanti);

                    try {
                        if(edicion)
                            EditBook(bid, btitulo, bfecha, bautor, bcategoria, bedicion, bidioma, pag, bdescrip, stc, av, bejem);
                        else
                            InsertBook(bid, btitulo, bfecha, bautor, bcategoria, bedicion, bidioma, pag, bdescrip, stc, av, bejem);
    ...
    void setColor(JPanel panel){
        panel.setBackground(new Color(216,175,151));
    }
    void resetColor(JPanel panel){
        panel.setBackground(new Color(191,151,128));
    }
